      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <motion.div
            ...
            viewport={{ once: true, margin: '-100px' }}
            className="bg-secondary p-6 rounded-lg border border-primary"
          >
            ...
            <h3 className="text-xl font-bold mb-3 text-primary">Inspiring Talks</h3>
            <p className="text-secondary">
              Join industry experts and Go enthusiasts for talks covering everything from
              fundamentals to cutting-edge applications of Go.
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-3 text-primary">Workshops</h3>
            <p className="text-secondary">
              Deepen your knowledge with hands-on workshops led by Go experts, covering best
          ...
          >
            ...
            <p className="text-secondary">
              Connect with a vibrant community of Go developers, share experiences, and forge
