          ...
          >
            ...
            <div className="bg-primary rounded-lg p-6 md:p-8">
              <p className="text-secondary mb-4">
                Clubco is a modern coworking and event space located in the historic Vlněna textile
                factory, now transformed into a vibrant creative hub in Brno. The venue offers
                excellent facilities for conferences, with state-of-the-art AV equipment,
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-2">
                      ...
                      <ul className="list-disc list-inside space-y-1 text-secondary">
                        ...
                        <li>
                          Public parking at <strong>OC Vaňkovka</strong> shopping center (10 minutes
                          walk)
                        </li>
                      </ul>
                    </div>
                    ...
                    {selectedAirport === 'BRQ' && (
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <p className="text-secondary">
                            Take bus <strong>76</strong> or <strong>Airport Express</strong> to the
                            city center (Main Station), then walk 5 minutes to Clubco.
                          </p>
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <p className="text-secondary text-sm mt-2">
                            Duration: ~3.5 hours total | Cost: ~60 CZK (bus) + ~200-400 CZK (train)
                          </p>
                        ...
                        <div className="mt-4 p-3 bg-go-blue/10 rounded">
                          <p className="text-sm text-secondary">
                            <strong>Tip:</strong> PRG is the largest airport in Czech Republic with
                            excellent connections to Brno. Book train/bus tickets in advance for
                            better prices.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <ol className="list-decimal list-inside space-y-1 text-secondary">
                            ...
                            <li>Board a train to Brno (some require transfer in Wien Meidling)</li>
                            <li>Walk 5 minutes from Brno station to Clubco</li>
                          </ol>
                          <p className="text-secondary text-sm mt-2">
                        ...
                        <div className="mt-4 p-3 bg-go-blue/10 rounded">
                          <p className="text-sm text-secondary">
                            <strong>Tip:</strong> Vienna Airport is often cheaper for international
                            flights and closer to Brno than Prague. The direct bus is the easiest
                            option!
                          </p>
                        </div>
                      </div>
          ...
          >
            ...
            <div className="bg-primary rounded-lg p-6 md:p-8">
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-secondary mb-4">
                    Clubco is a wheelchair-accessible venue with elevators and accessible restrooms.
                    If you have any specific accessibility needs or questions, please contact us at{' '}
                    <a
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-secondary mb-6">
              If you need help finding the venue or have any questions about getting to Gophercamp,
